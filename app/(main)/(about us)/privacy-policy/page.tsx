...
const PrivacyPolicyPage = () => {
    return (
        <main className="flex min-h-screen flex-col items-center justify-between lg:p-20 md:p-24 py-20">
            <div className="prose lg:prose-xl">   <h1>Privacy Policy</h1>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Explore Wise Tips.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to Explore Wise Tips, accessible from <a href="https://www.explorewisetips.com" rel="external nofollow noopener" target="_blank">https://www.explorewisetips.com</a></p>
                    </li>
                    <li>
                ...
                <ul>
                    <li>
                        <p>By email: dimerbwimba191996@gmail.com</p>
                    </li>
                    <li>
                        <p>By visiting this page on our website: <a href="https://www.explorewisetips.com/contact" rel="external nofollow noopener" target="_blank">https://www.explorewisetips.com/contact</a></p>
                    </li>
                </ul>
            </div>
        </main>
